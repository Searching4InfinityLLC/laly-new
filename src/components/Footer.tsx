  ...
  return (
    <footer className="w-full bg-[#fffcf9]">
      ...
      <div className="section-shell flex flex-col items-center gap-12 px-5 pt-12 pb-5 sm:px-10 md:flex-row md:items-start md:justify-between md:gap-12 md:px-12 md:pt-12 md:pb-5">
        ...
        {/* NAV, SERVICES and CONTACT. mobile: one column, 80 between the groups, 20 under.
            desktop: their own space-between row filling the middle of the footer, 48 under. */}
        ...
        <nav aria-label="Footer" className="flex flex-col items-center gap-8 md:flex-1">
        ...
        {/* Same treatment as NAV and CONTACT — title, 32 to the list, 12 between links. Desktop row:
            logo | NAV | SERVICES | CONTACT | copyright. */}
